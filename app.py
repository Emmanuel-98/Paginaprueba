...
client = MongoClient("mongodb+srv://recuperacontrasena19:Anaheim!789@cluster0.6khqb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db = client['Prueba1'] #Nombre de tu base de datos aquí
collection = db['usuarios'] #Nombre de tu colección aquí

# Configuración de SendGrid
SENDGRID_API_KEY = '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' 
...
def enviar_email(destinatario, asunto, cuerpo):
    mensaje = Mail(
        from_email='desbloqueacontrasena@gmail.com',  # Cambia esto por tu correo
